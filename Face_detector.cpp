...
int main(int argc, const char** argv)
{
	...
	double scale = 1;
	nestedCascade.load(std::string(PROJECT_SOURCE_DIR) + "/resources/haarcascades/haarcascade_eye_tree_eyeglasses.xml");
	cascade.load(std::string(PROJECT_SOURCE_DIR) + "/resources/haarcascades/haarcascade_frontalface_default.xml");
